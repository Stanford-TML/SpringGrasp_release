...
def euler_angles_to_axis_angle(euler_angles, convention: str) -> torch.Tensor:
    """
    ...
    return matrix_to_axis_angle(
        euler_angles_to_matrix(euler_angles, convention=convention)
    )
...
def axis_angle_to_euler_angles(axis_angle: torch.Tensor, convention: str) -> torch.Tensor:
    ...
    return matrix_to_euler_angles(
        axis_angle_to_matrix(axis_angle), convention=convention
    )
